...
import { DivvyHeatMapValetComponent } from './components/divvy-heat-map-valet/divvy-heat-map-valet.component';
...
const routes: Routes = [
  ...
  { path: 'heat_map_valet', component: DivvyHeatMapValetComponent},
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    AgmCoreModule.forRoot({apiKey: 'GOOGLE-MAP-API'+ '&libraries=visualization'}),
    FormsModule,
    NgbModule,
    MatCheckboxModule
